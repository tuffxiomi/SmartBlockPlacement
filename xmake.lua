...
-- Preloader's Logger.hpp requires fmt.
...
target("SmartBlockPlacement")
    ...
    -- Package the compiled .so into a .levipack.
    after_build(function (target)
        ...
        assert(
            python,
            "Python 3 is required to package SmartBlockPlacement.levipack"
        )
